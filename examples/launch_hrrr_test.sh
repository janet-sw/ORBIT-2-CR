...
#SBATCH -t 00:30:00
#SBATCH -q debug
#SBATCH -o logs/hrrr-test-%j.out
#SBATCH -e logs/hrrr-test-%j.out
...
# ============================================================
# HRRR Test Set Evaluation
# ============================================================
# Reports: ACC, RMSE, lat_mse, SSIM on the full test set.
# Results are printed to stdout and saved to a JSON file.
#
# Change the checkpoint path as needed.
# Use --output to specify the JSON output filename.

CHECKPOINT="/lustre/orion/csc662/proj-shared/janet/checkpoints/hrrr_refc/checkpoint_epoch_0029.pt"
CONFIG="/ccs/home/janetw/diffusion/ORBIT-2-main/configs/hrrr_forecasting.yaml"

time srun -n $((SLURM_JOB_NUM_NODES*8)) \
python /ccs/home/janetw/diffusion/ORBIT-2-main/examples/hrrr_test.py ${CONFIG} \
    --checkpoint ${CHECKPOINT} \
    --output test_results_epoch30.json